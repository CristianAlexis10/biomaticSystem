...
class AuthController{
  ...
  function logIn(){
    ...
    if ($email!="" && $email!=" " && $pass !=  "" && $pass !=  " ") {
      $issetUser= $this->master->selectBy("usuario",array("usu_correo",$email));
      if ($issetUser!=array()) {
          if ($issetUser['usu_estado']=="Activo") {
            $dataAcesso = $this->master->selectBy("acceso",array("usu_codigo",$issetUser['usu_codigo']));
